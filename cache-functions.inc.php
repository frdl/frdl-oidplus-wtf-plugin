 ...
 */
function wp_cache_add(int|string $key, $data,string $group = '', int $expire = 0 ) : bool {
 ...
 */
function wp_cache_replace(int|string $key, $data,string $group = '',int $expire = 0 ) : bool {
	global $wp_object_cache;
 ...
 */
function wp_cache_set(int|string $key, $data,string $group = '', int $expire = 0 ) : bool  {
	global $wp_object_cache;
 ...
 */
function wp_cache_get(int|string $key,string $group = '',bool $force = false,bool &$found = null ) {
	global $wp_object_cache;
 ...
 */
function wp_cache_incr( int|string  $key,int $offset = 1,string $group = '' ) {
	global $wp_object_cache;
 ...
 * @return int|false The item's new value on success, false on failure.
 */
function wp_cache_decr(int|string $key,int $offset = 1,string $group = '' ) {
	global $wp_object_cache;
 ...
 */
function wp_cache_add_global_groups(string|array $groups ) {
	global $wp_object_cache;
 ...
 * @param string|string[] $groups A group or an array of groups to add.
 */
function wp_cache_add_non_persistent_groups(string|array $groups ) {
 ...
 */
function wp_cache_switch_to_blog(string | int $blog_id ) {
	global $wp_object_cache;
