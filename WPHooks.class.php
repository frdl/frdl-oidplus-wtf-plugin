...
class WPHooks
{
   ...
   */
  //Huggable Autoloader is fuckable autoloader: protected function __construct(?Shortcodes $Shortcodes = null)
   protected function __construct($Shortcodes = null)
  {
	  $this->Shortcodes =is_null($Shortcodes) ? new Shortcodes($this) : $Shortcodes;
  }
   ...
   public static function __callStatic($method, $params)
    ...
    {
       return \call_user_func_array([$this->codes(), $method], $params);
    }	
   ...
   * @return Hooks
   */
  public static function getInstance(?Shortcodes $Shortcodes = null): self
  {    

    if (null === static::$instance) {
      static::$instance = new self($Shortcodes);
    }
  ...
  {
	  try{
	      $r = \call_user_func_array([$this->Shortcodes, __FUNCTION__], func_get_args());
		  return is_bool($r) ? $r : true;
	  }catch(\Exception $e){
		 return false;  
	  }
	  /*
  ...
  {
	   return \call_user_func_array([$this->Shortcodes, __FUNCTION__], func_get_args());
	  /*
  ...
  {
		    return \call_user_func_array([$this->Shortcodes, 'shortcodeRegex'], func_get_args());
	  /*  
