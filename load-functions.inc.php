...
function wp_is_jsonp_request() {
	...
	if ( ! function_exists( 'wp_check_jsonp_callback' ) ) {
		//require_once ABSPATH . WPINC . '/functions.php';
		throw new \ViaThinkSoft\OIDplus\Core\OIDplusException(sprintf('Function %s is not supported yet in function %s!', 
											  'wp_check_jsonp_callback', 
											  __FUNCTION__), 
									          'Unsupported wp- shim/wtf function called',
									          409);
	}
 ...
 */
function wp_is_json_media_type(string $media_type ) {
	static $cache = array();
 ...
 */
function wp_is_site_protected_by_basic_auth(string $context = '' ) {
	global $pagenow;
